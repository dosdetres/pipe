class MenuOptionsController < ApplicationController
  ...
  def destroy
    @menu_option.destroy
    respond_to do |format|
      format.html { redirect_to menu_options_url, notice: 'El Módulo se eliminó correctamente.' }
  ...
  private
    ...
    def menu_option_params
      params.require(:menu_option).permit(:modulo, :descripcion, :orden, :ruta, :imagen, :consorcio, :activo, :menu_option_id)
    end
end
